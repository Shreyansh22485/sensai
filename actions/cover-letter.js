...
export async function getCoverLetters(){
    const {userId} = await auth()
    if(!userId){
        throw new Error("You must be logged in to get cover letters")
    }
...
export async function getCoverLetter(id){
    const {userId} = await auth()
    if(!userId){
        throw new Error("You must be logged in to get a cover letter")
    }
...
export async function deleteCoverLetter(id){
    const {userId} = await auth()
    if(!userId){
        throw new Error("You must be logged in to delete a cover letter")
    }
